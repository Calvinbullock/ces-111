def main():
    ...
    # Check if the vin is 
    # a key that is in the vehicles dictionary.
    if vehicles_dict[vin]:

        # Find the data for the vehicle that the user wants.
        target_vehicle = vehicles_dict[vin]        

        # Print the manufacturer, model, and color of the vehicle.
        # Don't print the year, engine design, or displacement.
        manufacturer = target_vehicle[1] 
        model = target_vehicle[2]
        color = target_vehicle[3]
