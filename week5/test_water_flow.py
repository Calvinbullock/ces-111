...
def test_pressure_loss_from_fittings():
    ...
    assert pressure_loss_from_fittings(1.65, 2) == approx(-0.109, 0.003)
    assert pressure_loss_from_fittings(1.75, 2) == approx(-0.122, 0.003)
    assert pressure_loss_from_fittings(1.75, 5) == approx(-0.306, 0.003)
...
def test_pressure_loss_from_pipe_reduction():
    ...
    assert (
        pressure_loss_from_pipe_reduction(0.28687, 1.65, 471729, 0.048692) == approx(-163.744, 0.001)
    )
    assert (
        pressure_loss_from_pipe_reduction(0.28687, 1.75, 500318, 0.048692) == approx(-184.182, 0.001)
    )
